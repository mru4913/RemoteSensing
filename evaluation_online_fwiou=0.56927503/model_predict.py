...
def predict_by_two_way(model, img, std, do_tta_on_large_img):
    ...
    elif 620 < img_h <= 704 and 620 < img_w <= 704: # <=1 batch 
        label = predict_sliding(model, img, std, do_tta_on_large_img, overlap=0.75)         
    elif 704 < img_h <= 1026 and 704 < img_w <= 1026: # <=2 batches
        label = predict_sliding(model, img, std, do_tta_on_large_img, overlap=0.70) 
    elif 1026 < img_h <= 2048 and 1026 < img_w <= 2048: # <=6 batches
