...
__all__ = ['get_mc_unet3_b0','get_mc_unet3_b1','get_mc_unet3_b2','get_mc_unet3_b3','get_mc_unet3_b4', 
            'get_mc_unet3_b5','get_mc_unet3_b6','get_mc_unet3_b7']
...
class EfficientUnet(nn.Module):
    ...
    def forward(self, x):
        ...
        x3_0_atten = self.attenConv3(x3_0_aspp, self.up(x4_0))
